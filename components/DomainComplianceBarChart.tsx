...
export const DomainComplianceBarChart: React.FC<DomainComplianceBarChartProps> = ({ data, onSelectDomain }) => {
        ...
        chartRef.current = new Chart(canvasRef.current, {
            ...
            options: {
                ...
                onClick: (e: any, elements: any) => {
                    if (elements.length > 0 && onSelectDomain) {
                        const index = elements[0].index;
                        const domainName = processedData.labels[index];
